...
public partial class DungeonStateFactory : ObservableObject, IDungeonStateFactory
{
    private readonly IMordorIoFactory _ioFactory;
    private readonly IDialogFactory _dialogFactory;

    public DungeonStateFactory(IMordorIoFactory ioFactory, IDialogFactory dialogFactory)
    {
